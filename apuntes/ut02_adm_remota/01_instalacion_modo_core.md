...
Apartado:                   Instalación de Windows Server Core
...
### 1.2.- Activar y desactivar experiencia de escritorio (solo hasta Windows Server 2016)
...
### 1.3.- Tareas de post-instalación en modo Core
...
#### 1.3.1.- Cambio del nombre del equipo
...
#### 1.3.2.-Establecer una dirección IP estática
...
#### 1.3.3.- Configuración de NIC Teaming
...
### 1.4.- Configuración inicial con `sconfig`
